...
import automatl.juras.ui.platform.defaultDeviceName
...
fun PairingScreen(
    ...
    Column(
        ...
        Row(
            ...
            TextButton(onClick = { openLauncher() }) {
                Text("Import config")
            }
        }
...
private fun GuidedPairing(
    ...
    var label by rememberSaveable { mutableStateOf(existing?.label ?: defaultDeviceName) }
